...
2. Экран "Main" - отображает главную страницу приложения. При нажатии на кнопку + прекидывает на экран 3. При создании данного экрана я использовал элементы: текста, rectangle, circle, line и логотип.
   
3. Экран "New post" - отображает страницу создания и редактирования постов. При нажатии на кнопку "назад" прекидывает на экран 2. При создании данного экрана я использовал элементы: текста, rectangle, line. 
